...
# IRQ balance
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/qcom/msm_irqbalance.conf:system/vendor/etc/msm_irqbalance.conf
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/media/media_codecs_dolby.xml:system/etc/media_codecs_dolby.xml \
